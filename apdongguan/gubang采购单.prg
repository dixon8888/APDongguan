...
USE patrackorder
INDEX on contract2+item_no+contract0 TAG item_no   &&rushmore技术  
TOTAL ON contract2+item_no+contract0 TO d:\apdongguan\pareport1 FIELDS orderqty
USE pareport1
COPY TO pareport2 FIELDS item_no,supplier,descrip,orderqty,contract0,condate0,contract1,condate1,contract2,condate2,conprice0,conprice1,conprice2,conprice3,note FOR orderqty>0
COPY TO pareport FIELDS item_no,supplier,descrip,orderqty,contract0,condate0,contract1,condate1,contract2,condate2,conprice0,conprice1,conprice2,conprice3,note FOR orderqty>0

oExcel=Createobject("Excel.application")
oExcel.Workbooks.Open("E:\LWG\欧确纳固邦采购事宜\采购单\固邦采购订单模板.xls")
...
DO WHILE NOT EOF()
   SELECT 2
   LOCATE FOR  DELETED()=.f. AND ALLTRIM(item_no)=ALLTRIM(c.item_no) AND ALLTRIM(contract0)=ALLTRIM(c.contract0) 
     IF FOUND()
        DELETE
...
GO top
spinfo=ALLTRIM(supplier)
&&*************************
USE supplier
FOR spno=1 TO RECCOUNT()
GO spno
IF spinfo$supplier1 OR ALLTRIM(supplier1)$spinfo
coname=ALLTRIM(supplier2)
coadd=ALLTRIM(address)
cotel=ALLTRIM(tel)
cofax=ALLTRIM(fax)
cocontact=ALLTRIM(contact)
coemail=ALLTRIM(email)
EXIT
ENDIF
NEXT spno
&&****************************
...
&&******************
MR=6
oExcel.cells(MR,1).Value='供应商：'
oExcel.ActiveSheet.Rows(MR).RowHeight=13.5
MR1="B"+ALLTRIM(str(MR))+":"+"C"+ALLTRIM(str(MR))
oExcel.range(MR1).select
oExcel.selection.merge
oExcel.Selection.Font.Size=11
oExcel.Selection.Font.Name="宋体"
MR1="B"+ALLTRIM(str(MR))
oExcel.range(MR1).value=coname

MR=7
oExcel.cells(MR,1).Value='地址：'
oExcel.ActiveSheet.Rows(MR).RowHeight=13.5
MR1="B"+ALLTRIM(str(MR))+":"+"C"+ALLTRIM(str(MR))
oExcel.range(MR1).select
oExcel.selection.merge
...
oExcel.Selection.Font.Name="宋体"
MR1="B"+ALLTRIM(str(MR))
oExcel.range(MR1).value=coadd

MR=8
oExcel.cells(MR,1).Value='电话：'
oExcel.ActiveSheet.Rows(MR).RowHeight=13.5
MR1="B"+ALLTRIM(str(MR))+":"+"C"+ALLTRIM(str(MR))
oExcel.range(MR1).select
oExcel.selection.merge
...
oExcel.Selection.Font.Name="宋体"
MR1="B"+ALLTRIM(str(MR))
oExcel.range(MR1).value=cotel

MR=9
oExcel.cells(MR,1).Value='传真：'
oExcel.ActiveSheet.Rows(MR).RowHeight=13.5
MR1="B"+ALLTRIM(str(MR))+":"+"C"+ALLTRIM(str(MR))
oExcel.range(MR1).select
oExcel.selection.merge
...
oExcel.Selection.Font.Name="宋体"
MR1="B"+ALLTRIM(str(MR))
oExcel.range(MR1).value=cofax

MR=10
oExcel.cells(MR,1).Value='联系人：'
oExcel.ActiveSheet.Rows(MR).RowHeight=13.5
MR1="B"+ALLTRIM(str(MR))+":"+"C"+ALLTRIM(str(MR))
oExcel.range(MR1).select
oExcel.selection.merge
...
oExcel.Selection.Font.Name="宋体"
MR1="B"+ALLTRIM(str(MR))
oExcel.range(MR1).value=cocontact

MR=11
oExcel.cells(MR,1).Value='电子邮件：'
oExcel.ActiveSheet.Rows(MR).RowHeight=13.5
MR1="B"+ALLTRIM(str(MR))+":"+"C"+ALLTRIM(str(MR))
oExcel.range(MR1).select
oExcel.selection.merge
...
oExcel.Selection.Font.Name="宋体"
MR1="B"+ALLTRIM(str(MR))
oExcel.range(MR1).value=coemail
&&******************
...
oExcel1.Workbooks.Open("E:\LWG\欧确纳固邦采购事宜\采购单\固邦采购订单模板multi.xls")
...
oExcel1.Selection.Font.Name="宋体"
MyRows1="A"+ALLTRIM(str(MyRows))
oExcel1.range(MyRows1).value='地址：北京经济技术开发区文化园西路8号院4号楼2013室'
...
oExcel1.range(MyRows1).value='邮编(Post Code)：100176'
MyRows=MyRows+1
MyRows1="A"+ALLTRIM(str(MyRows))+":"+"C"+ALLTRIM(str(MyRows))
oExcel1.range(MyRows1).select
oExcel1.selection.merge
...
oExcel1.Selection.Font.Name="宋体"
MyRows1="A"+ALLTRIM(str(MyRows))
oExcel1.range(MyRows1).value='Add：Room 2013,Building 4,Yard 8, Wenhuayuan West Road,Economic & Technical development Zone,Beijing,PRC.'
MyRows=MyRows+1
MyRows1="A"+ALLTRIM(str(MyRows))+":"+"C"+ALLTRIM(str(MyRows))
oExcel1.range(MyRows1).select
oExcel1.selection.merge
oExcel1.Selection.Font.Size=11
oExcel1.Selection.Font.Name="宋体"
oExcel1.range(MyRows1).value='电话(Tel)：+86 010 87925272'
MyRows1="F"+ALLTRIM(str(MyRows))+":"+"G"+ALLTRIM(str(MyRows))
oExcel1.range(MyRows1).select
oExcel1.selection.merge
oExcel1.Selection.Font.Size=11
oExcel1.Selection.Font.Name="宋体"
MyRows1="F"+ALLTRIM(str(MyRows))
oExcel1.range(MyRows1).value='传真(Fax)：+86 010 67523238'
MyRows=MyRows+1
MyRows1="A"+ALLTRIM(str(MyRows))+":"+"C"+ALLTRIM(str(MyRows))
oExcel1.range(MyRows1).select
oExcel1.selection.merge
...
oExcel1.Selection.Font.Name="宋体"
MyRows1="A"+ALLTRIM(str(MyRows))
oExcel1.range(MyRows1).value='网站(Url)：www.goodband.cn'
MyRows1="F"+ALLTRIM(str(MyRows))+":"+"G"+ALLTRIM(str(MyRows))
oExcel1.range(MyRows1).select
oExcel1.selection.merge
oExcel1.Selection.Font.Size=11
oExcel1.Selection.Font.Name="宋体"
MyRows1="F"+ALLTRIM(str(MyRows))
oExcel1.range(MyRows1).value='E-mail：goodband118@126.com'
...
&&******************
MR=6
oExcel1.cells(MR,1).Value='供应商：'
oExcel1.ActiveSheet.Rows(MR).RowHeight=13.5
MR1="B"+ALLTRIM(str(MR))+":"+"C"+ALLTRIM(str(MR))
oExcel1.range(MR1).select
oExcel1.selection.merge
oExcel1.Selection.Font.Size=11
oExcel1.Selection.Font.Name="宋体"
MR1="B"+ALLTRIM(str(MR))
oExcel1.range(MR1).value=coname

MR=7
oExcel1.cells(MR,1).Value='地址：'
oExcel1.ActiveSheet.Rows(MR).RowHeight=13.5
MR1="B"+ALLTRIM(str(MR))+":"+"C"+ALLTRIM(str(MR))
oExcel1.range(MR1).select
oExcel1.selection.merge
...
oExcel1.Selection.Font.Name="宋体"
MR1="B"+ALLTRIM(str(MR))
oExcel1.range(MR1).value=coadd

MR=8
oExcel1.cells(MR,1).Value='电话：'
oExcel1.ActiveSheet.Rows(MR).RowHeight=13.5
MR1="B"+ALLTRIM(str(MR))+":"+"C"+ALLTRIM(str(MR))
oExcel1.range(MR1).select
oExcel1.selection.merge
...
oExcel1.Selection.Font.Name="宋体"
MR1="B"+ALLTRIM(str(MR))
oExcel1.range(MR1).value=cotel

MR=9
oExcel1.cells(MR,1).Value='传真：'
oExcel1.ActiveSheet.Rows(MR).RowHeight=13.5
MR1="B"+ALLTRIM(str(MR))+":"+"C"+ALLTRIM(str(MR))
oExcel1.range(MR1).select
oExcel1.selection.merge
...
oExcel1.Selection.Font.Name="宋体"
MR1="B"+ALLTRIM(str(MR))
oExcel1.range(MR1).value=cofax

MR=10
oExcel1.cells(MR,1).Value='联系人：'
oExcel1.ActiveSheet.Rows(MR).RowHeight=13.5
MR1="B"+ALLTRIM(str(MR))+":"+"C"+ALLTRIM(str(MR))
oExcel1.range(MR1).select
oExcel1.selection.merge
...
oExcel1.Selection.Font.Name="宋体"
MR1="B"+ALLTRIM(str(MR))
oExcel1.range(MR1).value=cocontact

MR=11
oExcel1.cells(MR,1).Value='电子邮件：'
oExcel1.ActiveSheet.Rows(MR).RowHeight=13.5
MR1="B"+ALLTRIM(str(MR))+":"+"C"+ALLTRIM(str(MR))
oExcel1.range(MR1).select
oExcel1.selection.merge
...
oExcel1.Selection.Font.Name="宋体"
MR1="B"+ALLTRIM(str(MR))
oExcel1.range(MR1).value=coemail
&&******************
